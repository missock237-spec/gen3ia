...
const WORKSPACE_PRIMARY: NavRoute[] = [
  {
    ...
    label: "Missions",
    icon: "◈",
    description: "Tâches en cours, brouillons, validations et historique",
    contexts: ["workspace"],
    section: "primary",
    keywords: ["missions", "tâches", "agents", "historique"],
  },
  {
    id: "create",
    href: "/studio/create",
    label: "Créer",
    icon: "✦",
    description: "Composer une mission à partir d'un modèle métier",
    contexts: ["workspace"],
    section: "primary",
    keywords: ["créer", "nouveau", "modèle", "marketing", "sales", "rh", "finance"],
  },
  {
    id: "results",
    href: "/studio/results",
    label: "Résultats",
    icon: "▣",
    description: "Fichiers, rapports, images et livrables générés",
    contexts: ["workspace"],
    section: "primary",
    keywords: ["résultats", "livrables", "fichiers", "rapports"],
  },
  {
    id: "connections",
    ...
    contexts: ["workspace"],
    section: "primary",
    keywords: ["connexions", "intégrations", "composio", "applications"],
  },
  {
    id: "team",
    href: "/team",
    label: "Équipe",
    icon: "◎",
    description: "Membres, rôles et activité partagée",
    contexts: ["workspace"],
    section: "primary",
    keywords: ["équipe", "membres", "rôles"],
  },
];
...
const WORKSPACE_SECONDARY: NavRoute[] = [
  ...
  { id: "storage", href: "/storage", label: "Fichiers", icon: "□", description: "Stockage permanent de vos livrables", contexts: ["workspace"], section: "secondary", keywords: ["fichiers", "stockage"] },
