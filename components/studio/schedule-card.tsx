...
export function ScheduleCard({
  ...
  return (
    <article className="rounded-2xl border border-[var(--g3-border)] bg-neutral-50 p-4">
      ...
      <div className="mt-4 flex flex-wrap gap-2">
        ...
        <button disabled={busy} onClick={() => onLoadHistory(schedule)} className="rounded-lg border border-[var(--g3-border)] bg-white px-3 py-2 text-xs hover:bg-neutral-100">
          Historique
        </button>
        <button disabled={busy} onClick={() => onToggle(schedule)} className="rounded-lg border border-[var(--g3-border)] bg-white px-3 py-2 text-xs hover:bg-neutral-100">
      ...
      {history && (
        <div className="mt-3 space-y-1 rounded-xl border border-[var(--g3-border)] bg-white p-3">
          {history.length === 0 ? (
