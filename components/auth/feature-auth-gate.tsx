...
export function FeatureAuthGate({ children, feature, description }: FeatureAuthGateProps) {
  ...
  if (loading || checking) {
    return (
      <div className="min-h-full bg-[var(--g3-bg)] p-8 text-neutral-900">
        <div className="mx-auto flex min-h-[60vh] max-w-md items-center justify-center">
          <div className="w-full rounded-3xl border border-[var(--g3-border)] bg-white p-8 text-center shadow-[0_2px_10px_rgba(15,23,42,0.05)]">
