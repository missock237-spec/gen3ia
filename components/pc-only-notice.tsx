...
export function PcOnlyNotice({ deviceType }: { deviceType?: string }) {
  ...
  return (
    <div className="flex min-h-full items-center justify-center bg-[var(--g3-bg)] p-6 text-neutral-900">
      <div className="anim-scale-in w-full max-w-lg rounded-3xl border border-[var(--g3-border)] bg-white p-8 text-center shadow-[0_14px_40px_-18px_rgba(28,27,24,0.22)]">
