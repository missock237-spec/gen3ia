...
export default function DeveloperPage(){
  ...
  useEffect(()=>{if(tab==="connectors"){void loadConnectors();void loadProjectConnectors();}},[tab,loadConnectors,loadProjectConnectors]);
