          ...
          <div className="mt-6 grid gap-6 lg:grid-cols-2">
            <section className="rounded-3xl border border-[rgba(23,23,20,0.09)] bg-[var(--g3-surface)] p-5 shadow-[0_2px_10px_rgba(15,23,42,0.05)]">
              ...
              <div className="mt-5 space-y-3">
                {licenses.length === 0 ? <p className="rounded-2xl border border-dashed border-[var(--g3-border-strong)] p-6 text-center text-sm text-[var(--g3-faint)]">Aucune licence enregistrée.</p> : licenses.map((license) => (
            ...
            <section className="rounded-3xl border border-[rgba(23,23,20,0.09)] bg-[var(--g3-surface)] p-5 shadow-[0_2px_10px_rgba(15,23,42,0.05)]">
              ...
              <div className="mt-5 space-y-3">
                {purchases.length === 0 ? <p className="rounded-2xl border border-dashed border-[var(--g3-border-strong)] p-6 text-center text-sm text-[var(--g3-faint)]">Aucun achat enregistré.</p> : purchases.map((purchase) => (
