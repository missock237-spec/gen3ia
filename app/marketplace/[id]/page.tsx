  ...
  return (
    <div className="min-h-full bg-[var(--g3-bg)] p-4 text-neutral-900 sm:p-6 md:p-8">
      <div className="mx-auto max-w-6xl">
        ...
        <header className="mt-4 overflow-hidden rounded-[30px] border border-[var(--g3-border)] bg-white p-6 shadow-[0_2px_10px_rgba(15,23,42,0.05)] md:p-8">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
            ...
            <div className="w-full shrink-0 lg:w-72">
              <div className="rounded-2xl border border-[var(--g3-border)] bg-neutral-50 p-5 text-center"><div className="text-2xl font-bold text-violet-700">{price(extension.pricing)}</div><p className="mt-1 text-[11px] text-neutral-400">Paiement et entitlement vérifiés côté serveur</p></div>
