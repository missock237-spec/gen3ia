...
export default async function AdminLayout({ children }: Readonly<{ children: ReactNode }>) {
  ...
  if (!canAdmin) {
    return (
      <div className="min-h-full bg-[var(--g3-bg)] p-6 text-[var(--g3-text)] md:p-10">
        <div className="mx-auto flex min-h-[70vh] max-w-xl items-center justify-center">
          <section className="w-full rounded-3xl border border-[rgba(23,23,20,0.09)] bg-[var(--g3-surface)] p-8 text-center shadow-[0_14px_40px_-18px_rgba(28,27,24,0.22)]">
            <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-[var(--g3-elevated)] text-2xl">⛨</div>
            <p className="mt-5 text-xs font-semibold uppercase tracking-[.25em] text-[var(--g3-muted)]">Gen3ia · Administration</p>
            <h1 className="mt-3 font-serif text-2xl font-semibold">Espace d&apos;administration restreint</h1>
            <p className="mx-auto mt-3 max-w-md text-sm leading-6 text-[var(--g3-muted)]">
