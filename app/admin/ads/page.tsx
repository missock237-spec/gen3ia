    ...
    action: (
      <span className="flex items-center gap-2">
        ...
        <button
          ...
          className="rounded-full border border-white/20 px-3 py-1.5 text-xs font-semibold text-[var(--g3-text-secondary)] hover:bg-[var(--g3-surface)]/10 disabled:opacity-40"
        >
  ...
  return (
    <div className="space-y-7">
      ...
      {loading ? (
        ...
        <>
          <section aria-label="Créer un emplacement" className="rounded-3xl border border-white/10 bg-[var(--g3-surface)]/5 p-6">
            <h2 className="text-lg font-bold text-[var(--g3-text-secondary)]">Nouvel emplacement</h2>
            ...
            <button
              ...
              onClick={() => void create()}
              className="mt-4 rounded-full bg-[var(--g3-surface)] px-5 py-2.5 text-sm font-semibold text-[var(--g3-text)] transition hover:bg-[var(--g3-elevated)] disabled:opacity-40"
            >
              Créer l&apos;emplacement
            </button>
          </section>
          ...
          <section aria-label="Inventaire">
            <h2 className="mb-3 text-lg font-bold text-[var(--g3-text-secondary)]">Emplacements ({ads.length})</h2>
            <ResourceList
              rows={rows}
