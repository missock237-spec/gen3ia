...
export default function NotFound() {
  return (
    <div className="flex min-h-screen items-center justify-center bg-[var(--g3-bg)] p-5 text-[var(--g3-text)] md:p-8">
      <section className="anim-scale-in w-full max-w-lg rounded-3xl border border-[rgba(23,23,20,0.09)] bg-[var(--g3-surface)] p-8 text-center shadow-[0_14px_40px_-18px_rgba(28,27,24,0.22)]">
